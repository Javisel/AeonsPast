...
public class AeonsPast
{
    ...
    // Create a Deferred Register to hold CreativeModeTabs which will all be registered under the "aeonspast" namespace
    public static final DeferredRegister<CreativeModeTab> CREATIVE_MODE_TABS = DeferredRegister.create(Registries.CREATIVE_MODE_TAB, MODID);

    // Creates a new Block with the id "aeonspast:example_block", combining the namespace and path
    public static final DeferredBlock<Block> EXAMPLE_BLOCK = BLOCKS.registerSimpleBlock("example_block", BlockBehaviour.Properties.of().mapColor(MapColor.STONE));
    // Creates a new BlockItem with the id "aeonspast:example_block", combining the namespace and path
    public static final DeferredItem<BlockItem> EXAMPLE_BLOCK_ITEM = ITEMS.registerSimpleBlockItem("example_block", EXAMPLE_BLOCK);

    // Creates a new food item with the id "aeonspast:example_id", nutrition 1 and saturation 2
    ...
    public AeonsPast(IEventBus modEventBus, ModContainer modContainer)
    {
    ...
    public static class CommonModEvents {
        ...
        public static void onAddReloadListener(AddReloadListenerEvent event) {
            ...
            event.addListener(new ArmorDataLoader());
        }
    }
